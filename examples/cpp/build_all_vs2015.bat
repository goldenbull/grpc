...
@rem --------------------------------------------------------------------------------------
@rem build protobuf to generate protoc.exe
...
@rem --------------------------------------------------------------------------------------
@rem build grpc plugins for protoc.exe
pushd vsprojects
...
@rem --------------------------------------------------------------------------------------
@rem build grpc C# extension
pushd vsprojects
%nuget% restore grpc_csharp_ext.sln || goto :error
msbuild grpc_csharp_ext.sln /p:Configuration=Debug;Platform=Win32 /m || goto :error
msbuild grpc_csharp_ext.sln /p:Configuration=Release;Platform=Win32 /m || goto :error
msbuild grpc_csharp_ext.sln /p:Configuration=Debug;Platform=x64 /m || goto :error
msbuild grpc_csharp_ext.sln /p:Configuration=Release;Platform=x64 /m || goto :error
popd

@rem --------------------------------------------------------------------------------------
@rem build grpc C# lib
pushd src\csharp
...
msbuild grpc-test.sln /p:Configuration=Debug;Platform=Win32 /m || goto :error
msbuild grpc-test.sln /p:Configuration=Release;Platform=Win32 /m || goto :error
msbuild grpc-test.sln /p:Configuration=Debug;Platform=x64 /m || goto :error
msbuild grpc-test.sln /p:Configuration=Release;Platform=x64 /m || goto :error
popd
